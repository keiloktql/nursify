import { type BotCommand, type ChatPermissions, type InlineQueryResult, type InputFile, type InputMedia, type InputMediaAudio, type InputMediaDocument, type InputMediaPhoto, type InputMediaVideo, type InputSticker, type LabeledPrice, type MaskPosition, type PassportElementError, type ReactionType } from "../types.js";
...
export declare class Api<R extends RawApi = RawApi> {
    ...
    constructor(token: string, config?: ApiClientOptions, webhookReplyEnvelope?: WebhookReplyEnvelope);
    /**
     ...
     */
    createNewStickerSet(user_id: number, name: string, title: string, stickers: InputSticker[], sticker_format: "static" | "animated" | "video", other?: Other<R, "createNewStickerSet", "user_id" | "name" | "title" | "sticker_format" | "stickers">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerSetThumbnail(name: string, user_id: number, thumbnail: InputFile | string | undefined, signal?: AbortSignal): Promise<true>;
    /**
