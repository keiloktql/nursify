...
class Api {
    ...
    createNewStickerSet(user_id, name, title, stickers, sticker_format, other, signal) {
        return this.raw.createNewStickerSet({ user_id, name, title, stickers, sticker_format, ...other }, signal);
    }
    /**
    ...
    setStickerSetThumbnail(name, user_id, thumbnail, signal) {
        return this.raw.setStickerSetThumbnail({ name, user_id, thumbnail }, signal);
    }
    /**
